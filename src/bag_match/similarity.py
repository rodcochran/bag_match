...
class BagSimilarity:
    def __init__(self, model_name: str = "all-MiniLM-L6-v2"):
        """
        Initialize the BagSimilarity class with a sentence transformer model.
    ...
    def cosine_similarity_bags(self, bag1_embeddings: List[NDArray[np.float32]], bag2_embeddings: List[NDArray[np.float32]]) -> float:
        """
    ...
    def pre_trained_similarity(self, bag1: Set[str], bag2: Set[str], model_name: str = "all-mpnet-base-v2") -> float:
        """
        ...
        temp_model = SentenceTransformer(model_name, cache_folder="./models")
        temp_model.to("mps")
